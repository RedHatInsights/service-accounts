...
const OUIA_ID = 'service-accounts-table';
...
const SORT_FIELD_MAP: Record<number, SortByField> = {
  0: 'name',
  1: 'description',
  4: 'createdAt',
};

const SORT_FIELD_TO_INDEX: Record<SortByField, number> = {
  name: 0,
  description: 1,
  clientId: 2,
  createdAt: 4,
...
const DEFAULT_SORT_FIELD: SortByField = 'name';
const DEFAULT_SORT_ORDER: SortOrder = 'asc';

const FILTER_KEYS = ['name', 'clientId', 'creator'] as const;
