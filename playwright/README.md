# Service Accounts E2E Tests

This directory contains end-to-end tests for the service-accounts application using Playwright.
...
- `HCC_ENV_URL` - HCC environment URL (used for baseURL in Konflux)
